package ru.anroidapp.clientplanner.intface_procedure;
...
public class ProcedureHeaderListView extends ListView  {
    ...
    public ProcedureHeaderListView(Context context) {
        super(context);
        this.mContext = context;
    }


    public ProcedureHeaderListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }


    public ProcedureHeaderListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setAdapter(ListAdapter adapter) {
        this.mAdapter = (ProcedureHeaderAdapter) adapter;
    ...
    public void configureHeaderView(int position) {
        ...
        switch (state) {
            ...
            case IPinnedHeaderProcedure.PINNED_HEADER_GONE:
                mHeaderVisibility = false;
                break;
            case IPinnedHeaderProcedure.PINNED_HEADER_VISIBLE:
                ...
                break;
            case IPinnedHeaderProcedure.PINNED_HEADER_PUSHED_UP:

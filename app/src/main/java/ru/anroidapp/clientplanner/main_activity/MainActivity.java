package ru.anroidapp.clientplanner.main_activity;
...
import ru.anroidapp.clientplanner.LangUpdateText;
import ru.anroidapp.clientplanner.LanguageManager;
import ru.anroidapp.clientplanner.ProcedureActivity;
import ru.anroidapp.clientplanner.R;
import ru.anroidapp.clientplanner.animation.Circle;
import ru.anroidapp.clientplanner.animation.ZoomOutPageTransformer;
import ru.anroidapp.clientplanner.calendar.CalendarActivity;
import ru.anroidapp.clientplanner.main_activity.slide_nearest_sessions.ScreenSlidePagerAdapter;
import ru.anroidapp.clientplanner.record.RecordActivity;

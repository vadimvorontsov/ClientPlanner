...
public class ProcedureIndexBarView extends View {
    ...
    IIndexBarFilterProcedure mIndexBarFilter;


    public ProcedureIndexBarView(Context context) {
        super(context);
        this.mContext = context;
    }


    public ProcedureIndexBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }


    public ProcedureIndexBarView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.mContext = context;
    }


    public void setData(ProcedureHeaderListView listView, ArrayList<String> listItems, ArrayList<Integer> listSections) {
